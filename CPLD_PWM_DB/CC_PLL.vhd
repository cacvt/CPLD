...
architecture Structure of CC_PLL is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  1, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  2, CLKFB_DIV=>  25, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of CC_PLL is
    for Structure
